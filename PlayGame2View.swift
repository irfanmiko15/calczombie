...
struct PlayGame2View: View {
    ...
    @State var data:[ResultModel]=[
        .init(id: "9", value: "1.0", isTrue: false),
        .init(id: "6", value: "3.0", isTrue: false),
        .init(id: "4", value: "6.0", isTrue: false),
        .init(id: "1", value: "14.0", isTrue: false),
        .init(id: "2", value: "16.0", isTrue: false),
        .init(id: "5", value: "21.0", isTrue: false),
        .init(id: "7", value: "20.0", isTrue: false),
        .init(id: "8", value: "40.0", isTrue: false),
        .init(id: "10", value: "62.0", isTrue: false),
        .init(id: "3", value: "100.0", isTrue: false),
    ]
    let animation: Animation = Animation.linear(duration: 240.0)
    @State private var showArrow=false
    @State private var arrowMove=false
    //isActive=false to stop timer
    @State private var timeRemaining = 240.0
...
struct PlayGame2View_Previews: PreviewProvider {
