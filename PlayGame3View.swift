...
//
//  Created by Irfan Dary Sujatmiko on 18/04/23.
//
...
struct PlayGame3View: View {
    ...
    let animation: Animation = Animation.linear(duration: 360.0)
    @State private var showArrow=false
    @State private var arrowMove=false
    //isActive=false to stop timer
    @State private var timeRemaining = 360.0
...
struct PlayGame3View_Previews: PreviewProvider {
